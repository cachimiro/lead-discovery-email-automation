...
export default function DecisionMakerPage() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      const cats = String(form.get("decision_maker_category") || "ceo,marketing")
        .split(",")
  ...
  return (
    <div className="max-w-xl space-y-6">
      <h1 className="text-xl font-semibold">Find a Decision Maker&apos;s Email</h1>
